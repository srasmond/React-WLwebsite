                  ...
                  <div className="about-container">
                    <div className="row">
                      <div className="col-md-12">
                        ...
                        <br /><br /></p>
                        <p>Neem een gerust een kijkje in mijn <Link to="/projects" className={pathname === '/projects'?"current":null}><em>projecten</em></Link> voor het volledige gamma aan klussen die ik al uitgevoerd heb.
                        <br />
                        Uiteraard is de lijst niet beperkend en kan een oplossing op maat voor uw specifiek probleem voorgesteld wordt.<br />
